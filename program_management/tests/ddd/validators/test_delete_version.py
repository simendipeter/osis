...
class TestHaveContents(TestCase):
    ...
    def test_have_contents_case_have_contents_because_mandatory_structure_is_present_multiple_times(self):
        ...
        subgroup_1 = GroupYearFactory(academic_year=self.academic_year, education_group_type__name=GroupType.SUB_GROUP.name)
        child_subgroup1 = ElementGroupYearFactory(group_year=subgroup_1)
        GroupElementYearFactory(parent_element=parent_education_group_year, child_element=child_subgroup1,
                                                    parent=None,
                                                    child_branch=None)
        ...
        GroupElementYearFactory(parent_element=parent_education_group_year, child_element=elt_subgroup_2,
                                                    parent=None,
                                                    child_branch=None)
    ...
    def test_have_contents_case_contents_because_structure_have_child_which_are_not_mandatory(self):
        ...
        GroupElementYearFactory(parent_element=parent_education_group_year, child_element=child_mandataory_eleem,
                                                    parent=None,
                                                    child_branch=None)
        ...
        GroupElementYearFactory(parent_element=parent_education_group_year, child_element=child_no_mandataory_eleem,
                                                    parent=None,
                                                    child_branch=None)
        self.assertTrue(_have_contents_which_are_not_mandatory(education_group_year))
