...
IDENTIFICATION_FIELDS_CATEGORY = 'identification'
DIPLOMA_FIELDS_CATEGORY = 'diploma'
CONTENT_FIELDS_CATEGORY = 'content'

FIELDS_CATEGORIES = (IDENTIFICATION_FIELDS_CATEGORY, DIPLOMA_FIELDS_CATEGORY, CONTENT_FIELDS_CATEGORY)
